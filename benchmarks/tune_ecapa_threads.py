"""
Tunes ONNX Runtime thread settings for ECAPA FP16 ONNX model.
"""
...
for th in thread_options:
    ...
    for _ in range(2):
        _ = sess.run(["embedding"], {"audio_input": audio_input})
...
print(f"\nBest ECAPA thread count: {best_threads} with p50: {results[best_threads]:.2f} ms")
